<nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseEmployee" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav"><a class="nav-link" href="<?php echo e(route('employee.index')); ?>">Employee</a><a class="nav-link" href="<?php echo e(route('salary.index')); ?>">Salary</a><a class="nav-link" href="<?php echo e(route('promotion.index')); ?>">Promotion</a></nav>
                            </div>
                ...
                </nav><?php /**PATH C:\xampp\htdocs\HRMS\resources\views/side.blade.php ENDPATH**/ ?>