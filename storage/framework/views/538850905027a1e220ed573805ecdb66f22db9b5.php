                    ...
                    <div class="sb-sidenav-menu">
                        ...
                        <?php if(auth()->user()->usertype=='1'): ?>
                            ...
                            <a href="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                       ...
                                       <span><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <?php echo e(auth()->user()->name); ?><br>
                                       </span>
                            ...
                            <div class="collapse" id="collapseEmployee" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav"><a class="nav-link" href="<?php echo e(route('employee.index')); ?>">Employee</a><a class="nav-link" href="<?php echo e(route('salary.index')); ?>">Salary</a><a class="nav-link" href="<?php echo e(route('promotion.index')); ?>">Promotion</a>
                                </nav>
                            </div>
                            <?php endif; ?>
                            ...
                            <a class="nav-link" href="<?php echo e(route('salary.index')); ?>"
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Total Employee : <?php echo e($employ); ?></div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="<?php echo e(route('employee.index')); ?>">View Details</a>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body">Total Notice : <?php echo e($notice); ?></div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="<?php echo e(route('notice.index')); ?>">View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body">Total Attendance Today : <?php echo e($attendance); ?></div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">Leave Request : <?php echo e($leave); ?></div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="<?php echo e(route('leave.index')); ?>">View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
...
<?php /**PATH C:\xampp\htdocs\HRMS\resources\views/index.blade.php ENDPATH**/ ?>