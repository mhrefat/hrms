...
<form >
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control " id="desig" placeholder="Enter Leave Id Here" name="desig" required value="<?php echo e($dep->desig); ?>">
    </div>
  </div>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRMS\resources\views/Department/edit.blade.php ENDPATH**/ ?>