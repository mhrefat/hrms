...
<div class="container">
    ...
    <table class="table table-bordered" style="width: 130%">
        ...
        <tr>
            ...
            <td><a href="<?php echo e(url('/uploads/product/'.$single_data->image)); ?>" download>
        <img src="<?php echo e(url('/uploads/product/'.$single_data->image)); ?>" class="img-thumbnail" width="75"></a></td>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel project\laravel-permission-master\HRMS\resources\views/Employee/index.blade.php ENDPATH**/ ?>