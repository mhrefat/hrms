...
<div  style="width: 90%; " class="justify-content-center">
	...
	<td style="word-wrap: break-word"><h3>{{$holida->name}}</h3></td>
	</tr>
	<tr>
	...
	<td><h3>{{$holida->start}}</h3></td>
	</tr>
	<tr>

		<td><h3>Holiday End</h3></td>
	<td><h3>{{$holida->end}}</h3></td>
	
	</tr>
		<td><h3>Status</h3></td>
	<td><h3>{{$holida->status}}</h3></td>
...
<div class="form-group row">
    <div class="col-sm-8">
      <a href="{{ route('holiday.index') }}" class="btn btn-warning"><h4>Back</h4></a>
    </div>
  </div>
  </div>
