...
<form >
  ...
  <div class="form-col" align="center">
    ...
    <label class="text-left"><h5><b>Profile Picture</b></h5></label>
    <div class="col-sm-8">
      <input type="file" class="form-control " id="image" placeholder="Image" name="image">

      <img src="<?php echo e(url('/uploads/product/'.$emplo->image)); ?>" class="img-thumbnail" width="100" />
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel project\laravel-permission-master\HRMS\resources\views/Employee/edit.blade.php ENDPATH**/ ?>