...
<div  style="width: 90%; " class="justify-content-center">
	...
	<td><h3><img src="<?php echo e(url('/uploads/product/'.$emplo->image)); ?>" class="img-thumbnail" width="100"/></h3></td>
	</tr>
	<tr>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel project\laravel-permission-master\HRMS\resources\views/Employee/show.blade.php ENDPATH**/ ?>